...
from neutron_checking.conf import common as common_config
from neutron_checking import version
...
oslo_messaging.set_transport_defaults(
    control_exchange='neutron-checking')
...
def init(args, **kwargs):
    cfg.CONF(args=args, project='neutron-checking',
