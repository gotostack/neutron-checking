...
from neutron_checking.db import api
from neutron_checking import worker as neutron_worker

CONF = cfg.CONF
common.register_socket_opts()
...
class Request(wsgi.Request):
    ...
    @property
    def context(self):
        if 'neutron-checking.context' not in self.environ:
            self.environ[
                'neutron-checking.context'] = context.get_admin_context()
        return self.environ['neutron-checking.context']
